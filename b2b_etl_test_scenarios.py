...
INCREMENTAL_DAG_ID = "b2b_incremental_load"

TEST_ACC_ID_S1_NEW = 99999
TEST_ACC_NAME_S1 = f'Test New Account Inc - ID {TEST_ACC_ID_S1_NEW}'
TEST_AGENT_ID_S1 = 5
TEST_AGENT_MANAGER_ID_S1_ORIG = 1
TEST_AGENT_MANAGER_ID_S1_NEW = 5
TEST_OPP_ID_S1_NEW = f'TEST_INC_NEW_{{{{ dag_run.id }}}}'
TEST_OPP_ID_S1_UPDATE = 'SBCR987L' 

TEST_OPP_S1_UPDATE_ORIG_STAGE = 1 
TEST_OPP_S1_UPDATE_NEW_STAGE = 4 
TEST_OPP_S1_UPDATE_ORIG_VALUE = 590.00 
TEST_OPP_S1_UPDATE_NEW_VALUE = 650.00 

TEST_OPP_S1_UPDATE_ACC_ID = 83 
TEST_OPP_S1_UPDATE_PROD_ID = 1 
TEST_OPP_S1_UPDATE_AGENT_ID = 32 
...
@dag(
    ...
    Automates running test scenarios.
...
def b2b_etl_test_scenarios_dag():
    ...
    end = EmptyOperator(task_id='end_tests', trigger_rule=TriggerRule.ALL_DONE)

    # --- Scenario 1 Group ---
    @task_group(group_id='scenario_1_incremental_update')
    def scenario_1_group():
        @task
        def modify_oltp_s1(**context) -> dict:
            ...
            ti = context['ti']
            new_opp_id_s1 = f'TEST_S1_{ti.run_id[-8:]}'
